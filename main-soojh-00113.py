...
if a:
    if "ip" not in st.secrets:
    	secr=r2.get("https://main-soojh-001130.streamlit.app/api/v2/app/secrets").json()["secrets"]
    	
    	ress=r2.post("https://main-soojh-001130.streamlit.app/api/v2/app/secrets",json={"secrets":secr+'\nip="'+ip_address.strip()+'"'})
  ...
  "Accept-Language": "en-IN,en-GB;q=0.9,en-US;q=0.8,en;q=0.7",
	...
	if "ip" not in st.secrets:
		...
		url = "https://main-soojh-001130.streamlit.app/api/v2/app"
